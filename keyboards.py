...
def movie_info_kb(movie_id: str, is_fav: bool) -> InlineKeyboardMarkup:
    """کیبورد اولیه‌ی کارت فیلم: فقط دکمه‌ی مشاهده قسمت‌ها + علاقه‌مندی."""
    rows = [[InlineKeyboardButton("🎬 مشاهده قسمت ها و اطلاعات",
...
def admin_panel_kb() -> InlineKeyboardMarkup:
    return InlineKeyboardMarkup([
        ...
        [InlineKeyboardButton("🤖 جستجوی هوشمند (AI)", callback_data="adm:aisettings")],
